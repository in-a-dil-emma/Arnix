async function replaceTemporaryFields() {
    ...
    const stabledata = await fetch('https://api.github.com/repos/in-a-dil-emma/Arnix/releases/latest')
    ...
    const devdata = await fetch('https://api.github.com/repos/in-a-dil-emma/Arnix/commits/dev')
